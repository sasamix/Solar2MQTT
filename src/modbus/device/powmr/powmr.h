...
private:
    ...
    inline static const modbus_register_t registers_static[] = {
        ...
        {4544, MODBUS_TYPE_HOLDING, REGISTER_TYPE_U16_SWAP, DESCR_Battery_Back_To_Utility_SOC, 0, {}, nullptr, kSettingsBlockStart, kSettingsBlockCount},
        {4545, MODBUS_TYPE_HOLDING, REGISTER_TYPE_U16_SWAP, DESCR_Battery_Back_To_Battery_SOC, 0, {}, nullptr, kSettingsBlockStart, kSettingsBlockCount},
